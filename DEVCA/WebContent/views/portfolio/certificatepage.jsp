...
function attachAddr(){
   const str = '<div class="certificate-item"><hr/><br/>'+
               '<span class="deletepage btn btn-primary btn-sm" style="float: right;">삭제</span>'+
               '<input type="hidden" name="certificate_count" value="0"/>'+
               '<label>수상/ 취득내역</label>'+
               ...
               '<label>설명</label>'+
               '<div class="input-group mb-3">'+
                  '<textarea class="form-control" rows="2" cols="40" name="certificate_ex_text" placeholder="위에서 적지 못한 자격증에 관한 사항을 적어주세요."></textarea>'+
               '</div>'+
            '</div>';
            
            $(".certificate-main").append(str);
            ...
            <div class="card p-4 my-3 bg-white">
               ...
               <input type="hidden" name="member_code" value="${sessionLoginMember.MEMBER_CODE }"/>
                  ...
                  <input type="hidden" name="certificate_seq" value="${certificateList.CERTIFICATE_SEQ }"/>
                     <div class="certificate-item"><hr/><br/>
                     <span class="deletepage btn btn-primary btn-sm" style="float: right;">삭제</span>
                     <input type="hidden" name="certificate_count" value="0"/>
                        <label>수상/ 취득내역</label>
                        <div class="input-group mb-3">
                     ...
                     <div class="insert">
                        <a href="#" class="btn btn-primary btn-sm" onclick="attachAddr();" >자격증 추가</a>
                     </div>
                  </div>
