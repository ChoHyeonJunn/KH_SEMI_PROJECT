	      	...
	      	<div class="card p-4 my-3 bg-white">
			      ...
			      <div class="preview-main">
			      	...
			      	<c:forEach items="${workList }" var="workList">
			      		<dl>
			      			<dd>${workList.INCOME }만원이상 </dd>
			      		</dl>
			      	<br/><h4>희망 직군</h4><hr/>
			      		<dl>
			      			<dd>${workList.LINE_OF_WORK } </dd>
			      		</dl>
			      	</c:forEach>
			      	<br/><h4>업무 경험
			      	   <span>
			      	...
			      	<c:forEach items="${careerList }" var="careerList" >
			      		...
			      		<dl>
			      			...
			      			<c:forEach items="${careerdetailList }" var="careerdetailList">
			      			<div>
			   					<ul>
			   						<li>${careerdetailList.PERFORMANCE }</li>
			   					</ul>
			   					<p>${careerdetailList.DETAIL_CONTEXT }</p>
			   				</div>
			      			</c:forEach>
