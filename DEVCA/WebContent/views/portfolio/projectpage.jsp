...
<script type="text/javascript">
   ...
   function attachAddr(){
      const str =' <div class="project-item"><hr/><br/>'+
      '<c:set var="year" value="2020"/>'+
      '<input type="hidden" name="project_count" value="0"/>'+
         ...
         '<div class="input-group mb-3">'+
            '<textarea class="form-control"  id="detail_work" name="project_detail" rows="2" cols="50"></textarea>'+
         '</div>'+
