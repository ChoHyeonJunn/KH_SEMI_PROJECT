...
SELECT * FROM MEMBER;
DELETE FROM MEMBER WHERE MEMBER_CODE = 7;
-- INSERT 기본 형식
INSERT INTO MEMBER
...
-- 주요기술 INSERT
INSERT INTO SKILL
VALUES(SKILL_SEQ.NEXTVAL, (SELECT MEMBER_CODE FROM MEMBER WHERE MEMBER_CODE = 8), 'JAVA');

UPDATE SKILL SET SKILL = 'JAVA' WHERE SKILL_MEMBER_CODE = 8 
AND SKILL_SEQ = 27
------------------ 외국어
-- 외국어 시퀀스
...
CREATE TABLE CERTIFICATE(
	...
	CERTIFICATE_MEMBER_CODE NUMBER NOT NULL,
...
SELECT DATE_OF_DEPARTURE, DAY_OF_ENTRY FROM CAREER
WHERE CAREER_MEMBER_CODE = 8
