...
//	}
	...
	public static int CourseraCrawlingWithoutSearching() {
		...
		String url = "https://www.coursera.org/browse/computer-science?page=2";
		
		driver.get(url);
		String a = driver.findElement(By.className("ais-InfiniteHits-list")).getText();
